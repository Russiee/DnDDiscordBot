            ...
            try {
                try {
                    ...
                    new MessageBuilder()
                            .setEmbed(new EmbedBuilder()
                                    ...
                                    .setTitle("Work")
                                    .setDescription("Great job! You've earned " + workDone.getPayout() + " gold for " + workDone.getTimeout() + " minutes of work!"))
                    ...
                    new MessageBuilder()
                            .setEmbed(new EmbedBuilder()
                                    .setAuthor(messageCreateEvent.getMessageAuthor())
                                    .setTitle("Work")
                                    .setDescription("Hold your horses! You've worked too recently, have some grog and wait " + e.getTimeLeft() + " minutes!"))
                            .send(messageCreateEvent.getChannel());
                }
                ...
                new MessageBuilder()
                        .setEmbed(new EmbedBuilder()
                                .setAuthor(messageCreateEvent.getMessageAuthor())
                                .setTitle("Work")
                                .setDescription("You have not chosen a job yet! Choose one from `!work list` and by using `!work <job>`"))
                        .send(messageCreateEvent.getChannel());
            }
        }
        //2 - show work list
            ...
            new MessageBuilder()
                    .setEmbed(new EmbedBuilder()
                            .setAuthor(messageCreateEvent.getMessageAuthor())
                            .setTitle("Work")
                            .setDescription("Free work available:\n" + workListString))
                    .send(messageCreateEvent.getChannel());
        }
        //3 - do work from list
